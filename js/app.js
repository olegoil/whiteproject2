...
window.App = {
    ...
    init: function () {
        ...
        WhiteCoin = WhiteContract.at('0x3eDc4F05262A61fd189268ca87Bd2cAEE525107b');
        // 0x838C133dA3C493D728d49FA94f4f9B1930651e2a
    ...
    // Sends tokens from user to user
    ...
    // Allows address to handle with amount of tokens
    ...
    // Gives the abillity to the minter to create WhiteCoin
    // tokens go to miners wallet, further he can
    // send using transfer
    ...
    // Gives the ability to send WhiteCoin
    // Can only be used by manager
    ...
    // Stops the abillity to send WhiteCoin
    // Can only be used by manager
    ...
    // Freezes account. After it is impossible to send WhiteCoin
    ...
    // Creates new minting request for WhiteCoin
    // amount - amount of tokens to be created
    // ref - linetype
    mintingRequest: function (val1, amount, ref) {
        WhiteCoin.mintingRequest(this.convertSendAmount(amount), ref, (error, result) => {
            ...
            WhiteCoin.NewMintingRequest().watch((err, response) => {
                console.log(response.args.amount); // emissionssumm
                console.log(response.args.id); // request number, that we put into mintWhitecoin()
                // TODO: here worker
...
window.addEventListener('load', function() {
    if (typeof web3 !== 'undefined') {
        ...
        // TODO: Force user to download or config MetaMask
