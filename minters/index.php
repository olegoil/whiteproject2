...
<head>
  ...
  <title>Minters | <?php echo COIN_NAME; ?></title>
...
<body class="nav-md">
  ...
  <script src="../js/pace/pace.min.js"></script>
	...
	<script type="text/javascript" src="../js/minters/restunrest.js"></script>
	<script type="text/javascript" src="../js/minters/mintertbls.js"></script>
