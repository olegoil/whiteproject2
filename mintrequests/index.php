...
<head>
  ...
  <title>Mintrequests | <?php echo COIN_NAME; ?></title>
...
<body class="nav-md">
  ...
  <script type="text/javascript" src="../js/mintrequests/transact.js"></script>
  <script type="text/javascript" src="../js/mintrequests/minttbls.js"></script>
