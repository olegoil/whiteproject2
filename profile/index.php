...
<head>
  ...
  <title>Profile | <?php echo COIN_NAME; ?></title>
                ...
                <div class="x_content">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                    ...
                    <ul class="list-unstyled user_data">
                      ...
                      <?php if(isset($_GET['usr'])) { ?>
                        <li>
                          <i class="fa fa-envelope user-profile-icon"></i> <?php echo $sql->getAdminUser($usr)['user_mail']; ?>
                        </li>
                      <?php } ?>
                    </ul>
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                        ...
                        <?php } ?>
                            <div class="form-group">
                              <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name">Name
                                <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_name']; ?>" <?php if(isset($_GET['usr']) || $sql->getUser()['user_passport_confirm'] == 1) { echo 'disabled'; } ?>>
                              </label>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-6 col-sm-6 col-xs-12" for="lastname">Lastname
                                <input type="text" id="lastname" name="lastname" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_lastname']; ?>" <?php if(isset($_GET['usr']) || $sql->getUser()['user_passport_confirm'] == 1) { echo 'disabled'; } ?>>
                              </label>
                            </div>
                            <div class="form-group">
                            ...
                            <!-- <div class="form-group">
                              <label for="email" class="control-label col-md-6 col-sm-6 col-xs-12">Email
                                <input type="email" id="email" name="email" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_mail']; ?>">
                              </label>
                            </div> -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="country" class="control-label col-md-6 col-sm-6 col-xs-12">Country
                                <input type="country" id="country" name="country" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_country']; ?>" <?php if(isset($_GET['usr']) || $sql->getUser()['user_adress_confirm'] == 1) { echo 'disabled'; } ?>>
                              </label>
                            </div>
                            <div class="form-group">
                              <label for="city" class="control-label col-md-6 col-sm-6 col-xs-12">City
                                <input type="city" id="city" name="city" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_city']; ?>" <?php if(isset($_GET['usr']) || $sql->getUser()['user_adress_confirm'] == 1) { echo 'disabled'; } ?>>
                              </label>
                            </div>
                            <div class="form-group">
                              <label for="plz" class="control-label col-md-6 col-sm-6 col-xs-12">Postalcode
                                <input type="plz" id="plz" name="plz" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_postal']; ?>" <?php if(isset($_GET['usr']) || $sql->getUser()['user_adress_confirm'] == 1) { echo 'disabled'; } ?>>
                              </label>
                            </div>
                            <div class="form-group">
                              <label for="address" class="control-label col-md-6 col-sm-6 col-xs-12">Address
                                <input type="address" id="address" name="address" class="form-control col-md-7 col-xs-12" value="<?php echo $sql->getAdminUser($usr)['user_adress']; ?>" <?php if(isset($_GET['usr']) || $sql->getUser()['user_adress_confirm'] == 1) { echo 'disabled'; } ?>>
                              </label>
                            </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                          ...
                          <p class="docwarn">To be able to upload your documents please fill personal data first. </p>
